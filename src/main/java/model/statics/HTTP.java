 ...
 *
 * <p>
 * 项目主页：<a href="http://kevinsawicki.github.io/http-request">http-request</a>，
 *
 *
 * 更新历史
 * <ul>
 *     <li>2013-12-12 搬运5.5版本，使用<a href="http://square.github.io/okhttp">OkHttp</a>替换JDK HttpURLConnection</li>
 *     <li>
 *         2014-03-05 搬运5.6版本
 *         <ol>
 *             <li>post(final CharSequence baseUrl, final Map<?, ?> params, final boolean encode) -> post(final CharSequence baseUrl, final boolean encode, final Map<?, ?> params)</li>
 *          </ol>
 *     </li>
 *     <li>2014-03-13 可以设置默认的connectTimeout和readTimeout</li>
 *     <li>2015-10-20 OkHttp更新到2.x</li>
 *     <li>2015-11-26 定义Http状态码</li>
 *     <li>2017-01-10 删除对OkHttp的依赖，OkHttp提供更加丰富的接口无法简单适配了，回归到纯粹JDK的封装</li>
 * </ul>
 *
 */
public class HTTP {
    public static int defaultConnectTimeout = 1000;
    public static int defaultReadTimeout = 1000;
    ...
    // for success
    public static final int SC_200_OK = HTTP_OK;
    public static final int SC_201_CREATED = HTTP_CREATED;
    public static final int SC_204_NO_CONTENT = HTTP_NO_CONTENT;

    // for redirects:
    public static final int SC_300_MULTIPLE_CHOICES = HTTP_MULT_CHOICE;
    public static final int SC_301_MOVED_PERMANENTLY = HTTP_MOVED_PERM;
    public static final int SC_302_MOVED_TEMP = HTTP_MOVED_TEMP;
    public static final int SC_303_SEE_OTHER = HTTP_SEE_OTHER;
    public static final int SC_304_NOT_MODIFIED = HTTP_NOT_MODIFIED;
    public static final int SC_307_TEMPORARY_REDIRECT = 307;

    // for client error
    public static final int SC_400_BAD_REQUEST = HTTP_BAD_REQUEST;
    public static final int SC_401_UNAUTHORIZED = HTTP_UNAUTHORIZED;
    public static final int SC_403_FORBIDDEN = HTTP_FORBIDDEN;
    public static final int SC_404_NOT_FOUND = HTTP_NOT_FOUND;
    public static final int SC_415_UNSUPPORTED_TYPE = HTTP_UNSUPPORTED_TYPE;
    public static final int SC_422_UNPROCESSABLE_ENTITY = 422;

    // for server error
    public static final int SC_500_INTERNAL_ERROR = HTTP_INTERNAL_ERROR;
    public static final int SC_501_NOT_IMPLEMENTED = HTTP_NOT_IMPLEMENTED;
    ...
    public static StringBuilder params(final StringBuilder result, final Map<?, ?> params) {
        if(params == null) {
            return result;
        }
    ...
    public static StringBuilder params(final StringBuilder result, final Object... params) {
        if(params == null) {
            return result;
        }
    ...
    public static HTTP get(final CharSequence baseUrl,
                           final boolean encode, final Map<?, ?> params) {
     ...
     * @return this request
     */
    public HTTP header(final Map.Entry<String, String> header) {
    ...
    public HTTP send(final Object... params) throws HttpRequestException {
    ...
    public HTTP send(final Map<?, ?> params) throws HttpRequestException {
        StringBuilder result = new StringBuilder();
        params(result, params);
     ...
     * @throws HttpRequestException
     */
    public HTTP form(final Map.Entry<?, ?> entry) throws HttpRequestException {
     ...
     * @throws HttpRequestException
     */
    public HTTP form(final Map.Entry<?, ?> entry, final String charset)
            throws HttpRequestException {
